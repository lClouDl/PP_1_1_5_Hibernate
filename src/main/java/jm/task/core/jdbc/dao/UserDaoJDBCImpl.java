...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public UserDaoJDBCImpl() {
        try{
            ...
            System.err.println("Не удалось настроить соединение с базой данных.");
        }
    }
    ...
    public void saveUser(String name, String lastName, byte age) {
        try (PreparedStatement preparedStatement = util.connection.prepareStatement("INSERT INTO users(name, lastName, age) VALUES(?, ?, ?);")){
